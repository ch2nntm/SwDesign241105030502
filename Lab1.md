...
- Mô tả tổng quát:
  + Ca sử dụng "Maintain TimeCard" cho phép nhân viên ghi nhận và quản lý thời gian làm việc của họ.
  + Ca sử dụng "Select Payment" cho phép nhân viên chọn phương thức thanh toán phù hợp với nhu cầu của họ.
- Biểu đồ lớp:
